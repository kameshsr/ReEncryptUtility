...
@Component
@Entity
@Table(name = "applicant_demographic1", schema = "prereg")
@NoArgsConstructor
public class DestinationDemographicEntity implements Serializable {

	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = 6705845720255847210L;

	@OneToMany(fetch = FetchType.EAGER, mappedBy = "demographicEntity")
	private List<DestinationDocumentEntity> documentEntity;
	...
	public List<DestinationDocumentEntity> getDocumentEntity() {
		return documentEntity;
	}

	public void setDocumentEntity(List<DestinationDocumentEntity> documentEntity) {
